...
function normalizePreviewUrl(rawUrl) {
  ...
  if (['localhost', '127.0.0.1', '0.0.0.0', '::1'].includes(parsed.hostname)) {
    throw new Error(
      'Ce QR pointe vers une adresse locale du PC. Pour le telephone, lance velt serve IP_DU_PC:8000 puis velt preview IP_DU_PC:8000 avec le telephone sur le meme Wi-Fi.'
    );
  }
